...
- Set `csv.pipelines.allowScripts` to `false` to disable them even in a trusted workspace. No-code steps keep working.
- The time limit is `csv.pipelines.timeoutMs`, defaulting to 10 seconds. Commands get six times that.
