---
title: Feature tour
description: Every capability of the CSV Grid Editor, with the screenshot that shows it — the grid, AutoFilter, find and replace, row and column surgery, statistics, charts, SQL, pipelines, export and the sidebar.
